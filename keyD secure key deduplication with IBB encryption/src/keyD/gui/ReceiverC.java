 ...
 * @author DELL
 */
public class ReceiverC extends javax.swing.JFrame {

    String keyWord = "ef50a0ef2c3e3a5fdf803ae9752c8c66";
    String fname, ct;

    /**
     * Creates new form ReceiverC
     */
    public ReceiverC() {
        initComponents();
        setTitle("UserC :: KeyD");

        int[] ports = new int[]{9993};
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ReceiverC.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    class PortListener implements Runnable {
        ...
        public void run() {
           ...
           if (this.port == 9993) {
                try {
                    ServerSocket sst = new ServerSocket(9993);
                    Socket cn;
                    while (true) {
                        cn = sst.accept();
