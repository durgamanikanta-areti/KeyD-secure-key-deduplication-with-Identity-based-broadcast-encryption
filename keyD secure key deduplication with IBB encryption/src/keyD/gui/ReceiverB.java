 ...
 * @author DELL
 */
public class ReceiverB extends javax.swing.JFrame {

    String keyWord = "ef50a0ef2c3e3a5fdf803ae9752c8c66";
    String fname, ct;

    /**
     * Creates new form ReceiverB
     */
    public ReceiverB() {
        initComponents();
        setTitle("UserB :: KeyD");
        int[] ports = new int[]{9992};
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        try {
            ...
            try {
                out1 = new PrintStream(new FileOutputStream("ReceiverB\\" + fname));
                out1.print(ct);
            } finally {
                if (out1 != null) {
                    out1.close();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ReceiverB.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        public void run() {
            ...
            if (this.port == 9992) {
                try {
                    ...
                    ServerSocket sst = new ServerSocket(9992);
                    Socket cn;
                    while (true) {
                        cn = sst.accept();
