 ...
 * @author DELL
 */
public class ReceiverA extends javax.swing.JFrame {

    String fname, ct;

    /**
     * Creates new form ReceiverA
     */
    public ReceiverA() {
        initComponents();
        setTitle("UserA :: KeyD");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ReceiverA.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
